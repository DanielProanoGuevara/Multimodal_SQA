# -*- coding: utf-8 -*-
"""
ECG unimodal SQIs + 3-class Logistic Regression (OOF-CV)

Purpose
-------
Train and evaluate a 3-class Logistic Regression classifier using unimodal ECG SQIs
...
#   Multimodal_SQA/tbme_code/3_unimodal_ecg/ecg_logres.py
...
OUT_DIR = "exp_step3_ecg_unimodal_allSQI_logreg_3class"
...
def save_confusion_matrix_artifacts(y_true, y_pred, labels, display_labels, out_prefix: str) -> None:
    ...
    ax.set_title("Step 3 — LogReg (ECG unimodal SQIs) — OOF Confusion Matrix (%)")
    plt.tight_layout()
...
save_confusion_matrix_artifacts(
    ...
    out_prefix="step3_ecg_logres_cv",
)
...
macro_csv = os.path.join(OUT_DIR, "step3_ecg_logres_cv_macro_metrics.csv")
...
per_class_csv = os.path.join(OUT_DIR, "step3_ecg_logres_cv_per_class_metrics.csv")
...
pred_csv = os.path.join(OUT_DIR, "step3_ecg_logres_oof_predictions.csv")
pred_df.to_csv(pred_csv, index=False)

# %% Minimal console summary
print(f"[Step 3] Saved outputs to: {OUT_DIR}")
print(" - Confusion matrix (% PNG):    step3_ecg_logres_cv_confusion_matrix_percent.png")
print(" - CV macro metrics:            step3_ecg_logres_cv_macro_metrics.csv")
print(" - CV per-class metrics:        step3_ecg_logres_cv_per_class_metrics.csv")
print(" - OOF predictions (per-row):   step3_ecg_logres_oof_predictions.csv")
